...
function talrimer_custom_colors_css() {
	...
	$saturation = apply_filters( 'talrimer_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	$saturation_selection = absint( apply_filters( 'talrimer_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	$lightness = apply_filters( 'talrimer_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	$lightness_hover = apply_filters( 'talrimer_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	$lightness_selection = apply_filters( 'talrimer_custom_colors_lightness_selection', 90 );
	...
	return apply_filters( 'talrimer_custom_colors_css', $theme_css, $primary_color, $saturation );
}
